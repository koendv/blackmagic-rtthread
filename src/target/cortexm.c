...
#endif
static bool cortexm_dwt(target_s *target, int argc, const char **argv);
static bool cortexm_dwt_ctrl_write(target_s *target, uint32_t new_ctrl);
...
static bool cortexm_dwt(target_s *const target, const int argc, const char **const argv)
{
	if (argc < 2) {
