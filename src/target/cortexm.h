...
#define CORTEXM_DWT_LAR     (CORTEXM_DWT_BASE + 0xfb0U)
...
#define CORTEXM_DWT_CTRL_POSTPRESET_MASK (0xfU << 1U)
#define CORTEXM_DWT_CTRL_POSTINIT_MASK   (0xfU << 5U)
#define CORTEXM_DWT_CTRL_CYCTAP          (1U << 9U)
#define CORTEXM_DWT_CTRL_PCSAMPLENA      (1U << 12U)
#define CORTEXM_DWT_CTRL_EXCTRCENA       (1U << 16U)
#define CORTEXM_DWT_CTRL_CPIEVTENA       (1U << 17U)
#define CORTEXM_DWT_CTRL_EXCEVTENA       (1U << 18U)
#define CORTEXM_DWT_CTRL_SLEEPEVTENA     (1U << 19U)
#define CORTEXM_DWT_CTRL_LSUEVTENA       (1U << 20U)
#define CORTEXM_DWT_CTRL_FOLDEVTENA      (1U << 21U)
#define CORTEXM_DWT_CTRL_CYCEVTENA       (1U << 22U)
#define CORTEXM_DWT_CTRL_NOPRFCNT        (1U << 24U)
#define CORTEXM_DWT_CTRL_NOCYCCNT        (1U << 25U)
#define CORTEXM_DWT_CTRL_NOEXTTRIG       (1U << 26U)
#define CORTEXM_DWT_CTRL_NOTRCPKT        (1U << 27U)

#define CORTEXM_DWT_CTRL_EVENTS_MASK \
	(CORTEXM_DWT_CTRL_CPIEVTENA | CORTEXM_DWT_CTRL_EXCEVTENA | CORTEXM_DWT_CTRL_SLEEPEVTENA | \
		CORTEXM_DWT_CTRL_LSUEVTENA | CORTEXM_DWT_CTRL_FOLDEVTENA | CORTEXM_DWT_CTRL_CYCEVTENA)

/* Instrumentation Trace Macrocell */
#define CORTEXM_ITM_BASE                 (CORTEXM_PPB_BASE + 0x0000U)
#define CORTEXM_ITM_TER                  (CORTEXM_ITM_BASE + 0xe00U)
#define CORTEXM_ITM_TCR                  (CORTEXM_ITM_BASE + 0xe80U)
#define CORTEXM_ITM_LAR                  (CORTEXM_ITM_BASE + 0xfb0U)
#define CORTEXM_ITM_TCR_ITMENA           (1U << 0U)
#define CORTEXM_ITM_TCR_TSENA            (1U << 1U)
#define CORTEXM_ITM_TCR_SYNCENA          (1U << 2U)
#define CORTEXM_ITM_TCR_DWTENA           (1U << 3U)
#define CORTEXM_ITM_TCR_SWOENA           (1U << 4U)
#define CORTEXM_ITM_TCR_TSPRESCALE_SHIFT 8U
#define CORTEXM_ITM_TCR_TSPRESCALE_MASK  (0x3U << CORTEXM_ITM_TCR_TSPRESCALE_SHIFT)
#define CORTEXM_ITM_TCR_GTSFREQ_SHIFT    10U
#define CORTEXM_ITM_TCR_GTSFREQ_MASK     (0x3U << CORTEXM_ITM_TCR_GTSFREQ_SHIFT)
#define CORTEXM_ITM_TCR_TRACEBUSID_SHIFT 16U
#define CORTEXM_ITM_TCR_TRACEBUSID_MASK  (0x7fU << CORTEXM_ITM_TCR_TRACEBUSID_SHIFT)

#define CORTEXM_LAR_UNLOCK 0xc5acce55U
